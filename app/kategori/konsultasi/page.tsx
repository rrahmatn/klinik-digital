            ...
            <div className="w-full h-fiy pt-[80px] flex flex-col">
                ...
                <div className="w-full h-fit flex pt-8 px-20 flex-col gap-4">
                    ...
                    <div className="w-full h-fit flex flex-row 2xl:px-20 px-12 my-4 py-4">
                        <div className="w-1/2 h-[500px] hover:shadow-lg shadow-sm bg-cover bg-center rounded-tl-[100px] text-[#f9f9f4] font-bold flex transition duration-200 items-center justify-center  hover:scale-105 cursor-pointer text-3xl  p-auto bg-[url('/img/konsul/konsul2.svg')]">Solusi UKM</div>
                        <div className="w-1/2 h-[500px] hover:shadow-lg shadow-sm bg-cover bg-center rounded-br-[100px] text-[#f9f9f4] font-bold flex transition duration-200 items-center justify-center  hover:scale-105 cursor-pointer text-3xl  p-auto bg-[url('/img/konsul/konsul3.svg')]">Solusi Korporat</div>
                    </div>
