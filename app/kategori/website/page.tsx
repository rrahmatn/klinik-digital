        ...
        <>
            <div className="w-full pt-[80px] h-fit flex flex-col">
                ...
                <div className="w-full h-fit flex flex-row items-end py-5 bg-gradient-to-br gap-2 2xl:px-28 md:px-10 px-2 from-[#111E2F] to-[#283340]">
                    <figure className="w-[120px] h-[140px] py-4 flex items-end items-center justify-center justify-center animate__animated animate__backInDown animate__delay-0.5s">
                ...
                <div className="md:px-16 px-2 text-3xl font-semibold my-4 text-[#555555]">Kategori</div>
                <div className="md:px-16 px-2 flex flex-row gap-3 my-3">
                ...
                <div className="md:px-16 px-2 w-full h-fit gap-3 flex flex-col my-2 text-[#1f1717]">
                   <AllWebsite/>
                </div>
                <div className="lg:px-16 md:px-6  sm:px-5 px-10 my-4">
                    <DivProduk />
                </div>
            </div >
        </>
