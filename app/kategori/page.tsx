            ...
            <div className="w-full h-fit pt-[80px] flex flex-col">
                ...
                <div className="w-full h-fit px-auto py-5 flex flex-row items-center justify-around">
                    {content1.map((item, index) => {
                        return (
                            <>
                                <Link href={item.url} key={index} className="xl:w-1/4 w-1/3 2xl:h-[520px] rounded-sm shadow-md h-96 bg-[#ffffff] hover:bg-[#F4A022] flex py-4 transition duration-250 hover:scale-105 overflow-visible flex-col items-center justify-between text-center">
                ...
                <div className="w-full h-fit flex gap-4 flex-col px-40 py-5 text-left">
                    <p className="text-[#1f1717] 2xl:text-3xl text-2xl text-semibold">Klinik Digital terbuka untuk anda</p>
